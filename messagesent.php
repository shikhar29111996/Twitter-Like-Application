...
$result = mysqli_query($connection,"SELECT * FROM friends WHERE status='conf'");
  ...
  <?php
								...
								$member_id=$_SESSION['SESS_MEMBER_ID'];							
								$post = mysqli_query($connection,"SELECT * FROM friends WHERE  status = 'conf' ")or die(mysqli_error($connection));
